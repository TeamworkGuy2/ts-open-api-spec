...
import RamlConverter = require("../RamlConverter");
...
suite("RamlConverter", function RamlConverterTest() {
    ...
    test("isRamlType()", function () {
        asr.isFalse(RamlConverter.isRamlType(<any>null));
    ...
    function ramlType(obj: RamlV1.TypeAny): RamlV1.TypeAny {
        return obj;
    }
