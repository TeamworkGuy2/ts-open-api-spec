...
import OpenApiConverter = require("../OpenApiConverter");
...
suite("OpenApiConverter", function OpenApiConverterTest() {
    ...
    test("createModelParameterFromType()", function () {
        var { parameter, classes } = OpenApiConverter.createModelParameterFromType("firstParam", {
            type: "object",
            properties: {
                sid: { type: "string", format: <any>"uniqueidentifier" }
            },
            additionalProperties: true,
        }, null, defaultTypeConverter);
    ...
    function openApiType(obj: OpenApiV2.Type): OpenApiV2.Type {
        return obj;
    }
     ...
     */
    function defaultTypeConverter(typeName: string, format?: string | null): CodeAst.Type {
