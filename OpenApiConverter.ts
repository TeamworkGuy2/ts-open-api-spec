...
module OpenApiConverter {
     ...
     * @see readType()
     */
    export function extractOpenApiModels(openApiDefinitions: OpenApiV2.Definitions, typeConverter: (typeName: string, format?: string | null) => CodeAst.Type, modelNamer = defaultModelNamer): { [name: string]: CodeAst.Class } {
    ...
    export function createModelParameterFromType(paramName: string, paramType: OpenApiV2.Type, openApiDefinitions: OpenApiV2.Definitions | null, typeConverter: (typeName: string, format?: string | null) => CodeAst.Type,
    ...
    export function readType(nameStack: string[], openApiType: (OpenApiV2.Schema | OpenApiV2.Type | OpenApiV2.Reference), objectVisitor: (clazz: CodeAst.Class) => void, openApiDefinitions: OpenApiV2.Definitions | null,
        ...
        // 'allOf' schema
            ...
            objType.classSignature.annotations = addAll(objType.classSignature.annotations, [{ name: "AllOf", arguments: { value: JSON.stringify(allTypes.map((type) => typeToString(type))).replace(/\",\"/g, "\", \"") } }]);
